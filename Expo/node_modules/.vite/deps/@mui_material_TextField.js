...
function useFloating(options) {
  ...
  const [latestMiddleware, setLatestMiddleware] = React66.useState(middleware2);
  ...
  const setReference = React66.useCallback((node2) => {
    if (node2 != referenceRef.current) {
      referenceRef.current = node2;
      _setReference(node2);
    }
  }, [_setReference]);
  const setFloating = React66.useCallback((node2) => {
...
var SelectInput = React122.forwardRef(function SelectInput2(props, ref) {
  ...
  const handleDisplayRef = React122.useCallback((node2) => {
